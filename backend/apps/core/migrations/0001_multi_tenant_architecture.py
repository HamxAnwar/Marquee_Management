...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform_name', models.CharField(default='Developer Platform', max_length=100)),
                ('platform_email', models.EmailField(default='admin@developerplatform.com', max_length=254)),
                ('platform_phone', models.CharField(blank=True, max_length=20)),
                ('support_email', models.EmailField(default='support@developerplatform.com', max_length=254)),
