...
class MenuItemAdmin(admin.ModelAdmin):
    list_display = ['name', 'category', 'base_price', 'serving_type', 'is_vegetarian', 'is_available']
    list_filter = ['category', 'serving_type', 'is_vegetarian', 'is_available', 'created_at']
    ...
    fieldsets = (
        ...
        ('Pricing & Serving', {
            'fields': ('base_price', 'serving_type')
        }),
        ('Details', {
            'fields': ('ingredients', 'preparation_time', 'is_vegetarian')
        }),
...
class MenuItemVariantAdmin(admin.ModelAdmin):
    list_display = ['menu_item', 'name', 'price_modifier', 'final_price', 'is_available']
