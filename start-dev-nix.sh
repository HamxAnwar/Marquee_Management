...
echo -e "${YELLOW}🚀 Starting Multi-Tenant Marquee Management System (Nix)${NC}"
...
# Run populate_menu_data.py to create packages
print('📦 Creating menu packages...')
" 2>/dev/null

python populate_menu_data.py 2>/dev/null || echo "Menu population completed"
